...
static void chassis_static(void)
{
    ...
    chassis_calculation();
    CAN_cmd_chassis(chassis_motion.motor_output_value[0], chassis_motion.motor_output_value[1], 
                    chassis_motion.motor_output_value[2], chassis_motion.motor_output_value[3]);
}
...
static void chassis_calculation(void)
{
    ...
    chassis[1].Set_Values(chassis_motion.wheel_target_omega[1], m3508.motor_omega[1]);
    chassis[2].Set_Values(chassis_motion.wheel_target_omega[2], m3508.motor_omega[2]);
    chassis[3].Set_Values(chassis_motion.wheel_target_omega[3], m3508.motor_omega[3]);
